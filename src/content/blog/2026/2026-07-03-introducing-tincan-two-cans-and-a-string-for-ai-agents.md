...
date: "2026-07-03"
excerpt: "My coding agents couldn't talk to each other, and I was the messenger pigeon. So I built tincan: a tiny Go CLI that lets Claude, Codex, and Antigravity message each other through a filesystem spool — no daemon, no polling, near-zero tokens while idle. The agents reviewed the code and drew the logo themselves."
